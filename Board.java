...
public class Board {
	...
	public boolean hasWon(Player thePlayer, int playerRow, int playerCol) {
		...
		if(cells[playerRow][0].content == thePlayer && cells[playerRow][1].content == thePlayer && cells[playerRow][2].content == thePlayer ||
				cells[playerCol][0].content == thePlayer && cells[playerCol][1].content == thePlayer && cells[playerCol][2].content == thePlayer)
		...
		if( cells[0][0].content == thePlayer && cells[1][1].content == thePlayer && cells[2][2].content == thePlayer ||
				...
				cells[0][0].content == thePlayer && cells[1][0].content == thePlayer && cells[2][0].content == thePlayer || 
				cells[0][1].content == thePlayer && cells[1][1].content == thePlayer && cells[2][1].content == thePlayer ||
				cells[0][2].content == thePlayer && cells[1][2].content == thePlayer && cells[2][2].content == thePlayer )
			return true;
