...
import javax.swing.*;
class GameMain extends JFrame implements ItemListener, ActionListener{
...
for(i=0;i<=7;i++){
  ...
  Icon icon3=b[(a[i][3]-1)].getIcon();
	...
	JOptionPane.showMessageDialog(GameMain.this,"!!!YOU won!!! click reset");			 break;
                   }
             else if(icon1==ic2){ 
             b[(a[i][1]-1)].setIcon(ic22);
             b[(a[i][2]-1)].setIcon(ic22);
             b[(a[i][3]-1)].setIcon(ic22); 
               JOptionPane.showMessageDialog(GameMain.this,"!!!AWK (COMPUTER) won!!! click reset");
                break;			 
               }
         }
    }  
